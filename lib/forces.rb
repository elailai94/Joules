...
# Joules
#
# @description: Module for providing forces equations
# @author: Elisha Lai
...
#          spring constant is in kilograms per second squared/
#          newtons per meter.
#          extension >= 0
...
# Conditions:
#     PRE: force is in kilogram meters per second squared/newtons.
#          distance >= 0
#          distance is in meters.
#     POST: Returns a Float.
#           returned value is in kilogram meters squared per second
#           squared/newton metres.
